...
## 👥 Credits
This package was created by [Essam Wisam](https://github.com/EssamWisam) as a Google Summer of Code project, under the mentorship of [Anthony Blaom](https://github.com/ablaom). Additionally, [Rik Huijzer](https://github.com/rikhuijzer) and his binary `SMOTE` implementation in `Resample.jl` have also been helpful.
