...
- `y::AbstractVector`: A categorical vector of labels that corresponds to the observations in X
- `k::Int`: Number of nearest neighbors to consider in the SMOTE algorithm. Should be within the range [1, numobs(X) - 1] else set to the nearest of these two values.
